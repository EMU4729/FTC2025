...
public class ThreeRectProcessor implements VisionProcessor {
    ...
    private android.graphics.Rect makeGraphicsRect (Rect rect, float scaleBmpPxToCanvasPx){
        ...
        int right = left + Math.round(rect.right*scaleBmpPxToCanvasPx);
        int bottom = top + Math.round(rect.bottom * scaleBmpPxToCanvasPx);
